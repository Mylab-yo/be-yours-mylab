# One Stop — blueprint v3 (barème 2025 vérifié) — remise fixe par unité

Type d'offre = **Remise uniquement** ; cible = **Produits spécifiques** ; palier = *Remise fixe par unité* (€/u ci-dessous). 1er palier = Aucune remise.
...
**Paliers :**
  - qté **14+** → remise **1,50 €/unité** (→ 13,40 €)
  - qté **28+** → remise **2,25 €/unité** (→ 12,65 €)
  - qté **42+** → remise **3,00 €/unité** (→ 11,90 €)
  - qté **54+** → remise **4,25 €/unité** (→ 10,65 €)
...
### Offre 4 — 7 produit(s) — base 9,50 € (qté 6+, aucune remise)
**Produits :** masque-nourrissant, masque-boucles, masque-lissant, masque-ha-repulpe, masque-volume, masque-protecteur-de-couleur, masque-intense
**Paliers :**
...
### Offre 5 — 7 produit(s) — base 8,50 € (qté 6+, aucune remise)
**Produits :** creme-boucles, creme-ha-repulpe, creme-lissante, creme-nourrissante, creme-volume, bain-miraculeux, huile-a-barbe
**Paliers :**
...
### Offre 6 — 6 produit(s) — base 16,90 € (qté 6+, aucune remise)
...
**Paliers :**
  ...
  - qté **24+** → remise **2,70 €/unité** (→ 14,20 €)
  - qté **48+** → remise **3,40 €/unité** (→ 13,50 €)
  - qté **96+** → remise **4,80 €/unité** (→ 12,10 €)

### Offre 7 — 6 produit(s) — base 32,90 € (qté 1+, aucune remise)
...
### Offre 8 — 6 produit(s) — base 7,50 € (qté 6+, aucune remise)
...
### Offre 9 — 6 produit(s) — base 28,90 € (qté 1+, aucune remise)
...
### Offre 10 — 6 produit(s) — base 9,60 € (qté 6+, aucune remise)
...
### Offre 11 — 6 produit(s) — base 34,90 € (qté 1+, aucune remise)
...
### Offre 13 — 1 produit(s) — base 17,90 € (qté 6+, aucune remise)
**Produits :** creme-boucles-500ml
**Paliers :**
  - qté **14+** → remise **2,40 €/unité** (→ 15,50 €)
  - qté **28+** → remise **3,50 €/unité** (→ 14,40 €)
  - qté **42+** → remise **4,60 €/unité** (→ 13,30 €)
  - qté **54+** → remise **5,80 €/unité** (→ 12,10 €)

### Offre 14 — 1 produit(s) — base 9,90 € (qté 6+, aucune remise)
...
### Offre 15 — 1 produit(s) — base 7,90 € (qté 6+, aucune remise)
