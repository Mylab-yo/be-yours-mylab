...
## Points à confirmer au build (non bloquants pour la maquette)
- Couleur d'accent exacte de la section (relevé visuel sur le PDF).
- % d'ingrédients naturels par produit (sinon valeur marque générique).
- Copy actifs/propriétés (idéalement tirée des fiches produit live).
- Nom exact en couverture : « LES REPIGMENTANTS » vs « REPIGMENTANTS / COLORISTEUR » (défaut : « LES REPIGMENTANTS », kicker « Coloristeur »).
