...
SKILLS = ["check-order", "check-customer"]
...
def main():
    ...
    run(ssh, "sleep 7 && docker exec hermes-gateway hermes skills list 2>&1 | grep -iE 'check-order|check-customer|installed|name' | head",
        label="verify skills")
